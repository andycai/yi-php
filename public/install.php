...
<body>
	...
	<p>
		The following tests have been run to determine if <a href="http://dongshanju.net/yi">Yi</a> will work in your environment.
	</p>
	...
	<table cellspacing="0">
		<tr>
			...
			<?php else: $failed = TRUE ?>
				<td class="fail">Yi requires PHP 5.3.3 or newer, this version is <?php echo PHP_VERSION ?>.</td>
			<?php endif ?>
		</tr>
		<tr>
			<th>System Directory</th>
			<?php if (is_dir(SYSPATH) AND is_file(SYSPATH.'classes/Yi'.EXT)): ?>
	...
	<?php if ($failed === TRUE): ?>
		<p id="results" class="fail">✘ Yi may not work correctly with your environment.</p>
	<?php else: ?>
	...
	<p>
		The following extensions are not required to run the Yi core, but if enabled can provide access to additional classes.
	</p>
	...
	<table cellspacing="0">
		<tr>
			...
			<?php if (extension_loaded('curl')): ?>
				<td class="pass">Pass</td>
			<?php else: ?>
				<td class="fail">Yi can use the <a href="http://php.net/curl">cURL</a> extension for the Http class.</td>
			<?php endif ?>
		</tr>
		<tr>
			<th>GD Enabled</th>
			<?php if (function_exists('gd_info')): ?>
				<td class="pass">Pass</td>
			<?php else: ?>
				<td class="fail">Yi requires <a href="http://php.net/gd">GD</a> v2 for the Image class.</td>
			<?php endif ?>
		</tr>
		<tr>
			<th>MySQL Enabled</th>
			<?php if (function_exists('mysql_connect')): ?>
				<td class="pass">Pass</td>
			<?php else: ?>
				<td class="fail">Yi can use the <a href="http://php.net/mysql">MySQL</a> extension to support MySQL databases.</td>
			<?php endif ?>
		</tr>
		<tr>
			<th>PDO Enabled</th>
			<?php if (class_exists('PDO')): ?>
				<td class="pass">Pass</td>
			<?php else: ?>
				<td class="fail">Yi can use <a href="http://php.net/pdo">PDO</a> to support additional databases.</td>
			<?php endif ?>
		</tr>
	</table>
