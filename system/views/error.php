...
<body>
<div id="kohana_error">
	<h1><span class="type"><?php echo $type ?> [ <?php echo $code ?> ]:</span> <span class="message"><?php echo htmlspecialchars( (string) $message, ENT_QUOTES, Yi::$charset, TRUE); ?></span></h1>
	...
	<div id="<?php echo $env_id ?>" class="content collapsed">
		...
		<div id="<?php echo $env_id ?>" class="collapsed">
			<table cellspacing="0">
				...
				<tr>
					<td><code><?php htmlspecialchars( (string) $key, ENT_QUOTES, Yi::$charset, TRUE); ?></code></td>
